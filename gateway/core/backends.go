...
func DefaultBackends() []Backend {
	return []Backend{
		...
		{Name: "distil-large-v3", URL: "http://whisper-distil-large:8000", Aliases: []string{"distil-large-v3", "Systran/faster-distil-whisper-large-v3"}, DisplayName: "Large Fast", Description: "large model accuracy at 6x speed, English only", Provider: "whisper"},
