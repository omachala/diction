---
title: "Why Diction"
description: Diction is an iOS keyboard built to be the bridge between you and AI. Voice when you can talk, keys when you can't. One focused job, done properly.
keywords: "why diction, diction philosophy, voice keyboard mission, ai bridge, voice to ai, iphone keyboard ai, dictation philosophy"
---
...
If you want the engineering thesis, read [How Diction Is Built](/engineering). If you want to know who's behind it, read [About the Author](/about). If you want to start using it, the App Store is one tap away.
